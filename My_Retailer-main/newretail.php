...
<html>
    ...
    <div class="form-center">
        ...
        <table>
        <tr>
            <td id="center"><h1>Retailer Registration</h1></td>
        </tr>
        <tr>
...
if(isset($_POST['submit'])){
	...
	$status="Not Approved";
    if($pwd1 == $pwd2){
        $sql2 = "select email from retail where email = '$email'";
    ...
    if($res2->num_rows > 0){
        echo 'Email Id already exists';
            ...
            $sql = "insert into retail(name,email,phone,address,dob,pwd,status)VALUES('$uname','$email','$phone','$address','$dob','$pwd1','$status')";
