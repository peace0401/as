...
<font color="#0000FF"> <CENTER><h3 class="display-3">Sign Up </h3></CENTER></font>
        <div class="container">
        <div class="row my-4">
        <div class="col-md-4">
                <div class="card text-center h-100" style=" border:2px solid #0d6efd;">
                    <a href="newstock.php" STYLE="text-decoration:none;"><div class="card-block" WIDTH="200PX" HIEGHT="200PX">
            ...
            <div class="col-md-4">
                <div class="card text-center h-100" style=" border:2px solid #0d6efd;">
                    <a href="newdistributor.php" STYLE="text-decoration:none;"><div class="card-block" WIDTH="200PX" HIEGHT="200PX">
            ...
            <div class="col-md-4">
                <div class="card text-center h-100" style=" border:2px solid #0d6efd;">
                    <a href="newretail.php" STYLE="text-decoration:none;"><div class="card-block" WIDTH="200PX" HIEGHT="200PX">
