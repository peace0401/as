...
?>
<html>
    <title>Admin|Home</title><head>         <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
   ...
   <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
    ...
    <body>
	  ...
	  <font color="#0000FF"><b><h4><span>&nbsp;&nbsp;Welcome : <?php
                                ...
                                <font color="#0000FF">  <CENTER><h3 class="display-3">APPROVE USERS</h3></CENTER></font>
        <div class="container">
        <div class="row my-4">
        <div class="col-md-4">
                <div class="card text-center h-100" style=" border:2px solid #0d6efd;">
                    <a href="admin_approve_stock.php" STYLE="text-decoration:none;"><div class="card-block" WIDTH="200PX" HIEGHT="200PX">
